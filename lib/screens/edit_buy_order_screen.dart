...
import '../utils/currency_helper.dart'; // Make sure this is imported
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          if (success) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Failed to update buy order'),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              if (success) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Buy order deleted successfully')),
                );
                Navigator.pop(context);
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('Failed to delete buy order'),
                    backgroundColor: Colors.red,
                  ),
                );
              }
